...
\visible<2->{\includegraphics[width=0.14\paperwidth]{imagenes/skeleto_detalle_cadena.jpg}}
\end{minipage}
\end{minipage}
...
\end{minipage}
\begin{minipage}[c]{0.29\linewidth}
\visible<2->{\includegraphics[width=0.16\paperwidth]{imagenes/equiv_volume.jpg}}
\end{minipage}
\end{minipage}
...
\end{minipage}
\begin{minipage}[c]{0.29\linewidth}
\visible<2->{\includegraphics[width=0.16\paperwidth]{imagenes/erlenmeyers.jpg}}
\end{minipage}
\end{minipage}
...
\end{minipage}
\begin{minipage}[c]{0.29\linewidth}
\visible<2->{\includegraphics[width=0.16\paperwidth]{imagenes/Sc40.jpg}}
\end{minipage}
\end{minipage}
...
\end{minipage}
\begin{minipage}[c]{0.29\linewidth}
\visible<2->{\includegraphics[width=0.16\paperwidth]{imagenes/vaso.jpg}}
\end{minipage}
\end{minipage}
...
\begin{center}
\only<3>{\includegraphics[width=0.4\paperwidth]{imagenes/pulso-eco_y_detalle3_ingles2.jpg}}
\only<4->{\includegraphics[width=0.4\paperwidth]{imagenes/banco_medicion_ingles.jpg}}
\end{center}
...
\begin{center}
\only<3>{\includegraphics[width=0.28\paperwidth]{imagenes/incident_scat_fields.pdf}}
\only<4->{\includegraphics[width=0.46\paperwidth]{imagenes/transducer_face.pdf}}
\end{center}
...
% 
%\end{minipage}
%\begin{minipage}[c]{0.55\v_{\text{total}_{bs}}(t) = v_\text{inc}(t) * \sum_{m=1}^{M} \tilde{f}_{\infty_m} H^{-1}_\text{spher}(R_m,h_m,t)linewidth}
